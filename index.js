...
const addProjectLayout = (projectCreationUI) => {
    let projectNameInputLabel = document.createElement("label");
    projectNameInputLabel.innerHTML = "Enter Project Name";
    projectNameInputLabel.style.padding = "1rem";
    projectCreationUI.appendChild(projectNameInputLabel);
...
const submitProject = (checkMark, projectName, topHeading) => {
    checkMark.addEventListener("click", () => {
        ...
        newProjectCreated.classList.add("project-button");
